...
{
       0,    41,    41,    47,    50,    52,    54,    58,    65,    67,
      74,    76,    83,    88,    90,    92,    94
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "WHILE", "NUMBER",
  "ID", "'+'", "'-'", "'*'", "'/'", "THEN", "'\\n'", "'>'", "'<'", "'='",
  "$accept", "program", "line", "while_stmt", "stmt", "cond", "exp", YY_NULLPTR
};
...
{
      -8,     0,    -8,    -4,    -2,    -8,    -8,     7,     8,    12,
      19,     6,    -8,    23,    23,    23,    23,    -8,    26,    27,
      -1,    -8,    18,    18,    -8,    -8,    -8,    -8,    -8,    -8,
      14
};
...
{
       2,     9,     3,     3,     4,     4,    22,    23,    24,    25,
      21,     5,    11,    30,    13,    14,    15,    16,    12,    17,
      13,    14,    15,    16,    18,    19,    15,    16,     4,    20,
      26,    27,     0,    28
};

static const yytype_int8 yycheck[] =
{
       0,     5,     3,     3,     5,     5,    13,    14,    15,    16,
       4,    11,    14,    20,     6,     7,     8,     9,    11,    11,
       6,     7,     8,     9,    12,    13,     8,     9,     5,    10,
       4,     4,    -1,    20
};
...
{
       0,    16,     0,     3,     5,    11,    17,    18,    21,     5,
      20,    14,    11,     6,     7,     8,     9,    11,    12,    13,
      10,     4,    21,    21,    21,    21,     4,     4,    18,    19,
      21
};
...
#line 1195 "y.tab.c"
  ...
  case 7: /* while_stmt: WHILE cond THEN stmt  */
#line 59 "while.y"
            {
                printf("read while\n");
