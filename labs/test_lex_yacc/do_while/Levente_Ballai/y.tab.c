...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUM", "VAR", "OP",
  "DO", "WHILE", "EQUAL", "GREATER", "LESS", "GREATER_EQUAL", "LESS_EQUAL",
  "COLON", "$accept", "program", "stmt", "assignment", "condition", YY_NULLPTR
};
...
{
       2,     3,     7,     4,     3,     9,     4,    13,    14,    11,
      10,    16,    15,    17,     8
};

static const yytype_int8 yycheck[] =
{
       0,     4,     8,     6,     4,     3,     6,     9,    10,     3,
       7,     4,    13,     4,     4
};
...
#line 1172 "y.tab.c"
  ...
  case 5: /* stmt: DO stmt WHILE condition COLON  */
#line 47 "do_while.y"
                                        { (yyval.np) = opr2(DO, (yyvsp[-3].np), opr2(WHILE, (yyvsp[-1].np), NULL)); }
#line 1178 "y.tab.c"
    break;

  case 6: /* assignment: VAR EQUAL NUM  */
#line 49 "do_while.y"
                          { (yyval.np) = opr2('=', setVar((yyvsp[-2].variable)), setConst((yyvsp[0].number))); }
#line 1184 "y.tab.c"
    break;

  case 7: /* condition: NUM GREATER VAR  */
#line 51 "do_while.y"
                           { (yyval.np) = opr2('>', setConst((yyvsp[-2].number)), setVar((yyvsp[0].variable))); }
#line 1190 "y.tab.c"
    break;

  case 8: /* condition: NUM LESS VAR  */
#line 52 "do_while.y"
                          { (yyval.np) = opr2('<', setConst((yyvsp[-2].number)), setVar((yyvsp[0].variable)); }
#line 1196 "y.tab.c"
    break;
