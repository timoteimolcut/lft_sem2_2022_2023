...
static const flex_int16_t yy_base[26] =
    {   0,
        0,    2,   44,   45,    0,    0,    0,   41,    5,    0,
        0,   40,   35,    0,    7,   45,   45,   11,   15,   19,
       23,   26,   30,   32,   35
    } ;

static const flex_int16_t yy_def[26] =
    {   0,
       18,   18,   17,   17,   19,   20,   21,   17,   17,   22,
...
static const flex_int16_t yy_nxt[53] =
    {   0,
       17,   17,   17,    5,    5,    5,    5,   10,   11,   16,
       16,    4,    4,    4,    4,    4,    6,    6,    6,    6,
        7,    7,    7,    7,    8,    8,    8,    8,   12,   12,
       12,   12,   12,   14,   14,   14,   16,   16,   16,   16,
       15,   13,    9,   17,    3,   17,   17,   17,   17,   17,
       17,   17
    } ;

static const flex_int16_t yy_chk[53] =
    {   0,
        0,    0,    0,    1,    1,    2,    2,    9,    9,   15,
       15,   18,   18,   18,   18,   18,   19,   19,   19,   19,
       20,   20,   20,   20,   21,   21,   21,   21,   22,   22,
       22,   23,   23,   24,   24,   24,   25,   25,   25,   25,
       13,   12,    8,    3,   17,   17,   17,   17,   17,   17,
       17,   17
    } ;
...
YY_RULE_SETUP
#line 3 "../../timestamp.l"
((0[0-9])|1[0-2]):[0-5][0-9]:[0-5][0-9]      {printf("timestamp");}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 6 "../../timestamp.l"
