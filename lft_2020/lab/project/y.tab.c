...
{
  "\"end of file\"", "error", "\"invalid token\"", "X", "CONST", "SIN",
  "COS", "DRAW", "FOR", "VAR", "IN", "TO", "BY", "IF", "ELSE", "PI", "E",
  "IFX", "COMA", "'\\n'", "':'", "'='", "'>'", "'<'", "'-'", "'+'", "'('",
  "')'", "'^'", "$accept", "program", "line", "for", "if", "then", "coma",
  "cond", "statement", "assign", "polinom", "monom", "term", YY_NULLPTR
};
...
#line 1367 "y.tab.c"
  ...
  case 9: /* for: FOR VAR IN term TO term then statement  */
#line 146 "grafix.y"
                {
			nrOfTabs--;
...
#line 1376 "y.tab.c"
  ...
  case 10: /* for: FOR VAR IN term TO term BY CONST then statement  */
#line 151 "grafix.y"
                {
			nrOfTabs--;
...
#line 1385 "y.tab.c"
  ...
  case 11: /* if: IF cond then statement  */
#line 158 "grafix.y"
                {
			nrOfTabs--;
...
#line 1394 "y.tab.c"
  ...
  case 12: /* if: IF cond then statement coma ELSE then statement  */
#line 163 "grafix.y"
                {
			nrOfTabs--;
